...
class UserExperienceListController extends BaseController {
  final ExperienceRepository _repo;

  UserExperienceListController(this._repo);
  ...
  getData({bool resetPage = false}) async {
    ...
    var result = await _repo.getUserExperiencesList(page: currentPage);
