...
class AppTheme {
  static ThemeData lightTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      headlineSmall: const TextStyle(color: AppColors.fontLight, fontSize: 12),
      ...
      titleSmall: const TextStyle(color: AppColors.fontLight, fontSize: 12),
  ...
  static ThemeData darkTheme = ThemeData(
    ...
    textTheme: TextTheme(
      ...
      headlineSmall: const TextStyle(color: AppColors.fontDark, fontSize: 12),
      headlineMedium: const TextStyle(
        color: AppColors.fontDark,
        fontSize: 15,
        fontWeight: FontWeight.bold,
